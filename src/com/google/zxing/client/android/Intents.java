...
public final class Intents {
    ...
    public static final class Scan {
         ...
         * rectangle in pixels.
         * The app will try to honor these, but will clamp them to the size of
         * the preview frame.
        ...
        /**
         * Desired duration in milliseconds for which to pause after a
         * successful scan before
         ...
         * if available. The actual values will be set under a series of keys
         * formed by adding 0, 1, 2, ...
